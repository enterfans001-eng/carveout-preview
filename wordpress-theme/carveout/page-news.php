...
<head>
  ...
  <meta name="description" content="CARVEOUTのニュース一覧ページです。">
  <title>ニュース | CARVEOUT</title>
  ...
  <main>
    ...
    <section class="section news-section">
      <div class="section-heading">
        <p class="eyebrow">ALL NEWS</p>
        <h2>すべてのニュース</h2>
      </div>
      <div class="news-tabs" id="newsYearTabs" aria-label="年別ニュース"></div>
      <div class="news-grid news-grid-all" id="allNewsGrid" aria-live="polite"></div>
    </section>
  </main>
