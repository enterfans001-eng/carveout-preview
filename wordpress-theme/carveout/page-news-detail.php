...
<head>
  ...
  <meta name="description" content="CARVEOUTのニュース詳細ページです。">
  <title>ニュース詳細 | CARVEOUT</title>
...
<a class="site-logo" href="<?php echo carveout_theme_page_url('index'); ?>" aria-label="CARVEOUT トップへ">
  ...
  <main>
    <section class="page-header">
      <p class="eyebrow" id="detailPageEyebrow">NEWS</p>
      <h1 id="detailPageTitle">ニュース詳細</h1>
    </section>

    <section class="section detail-section">
      <article class="detail-panel" id="newsDetail" aria-live="polite"></article>
    </section>
  </main>
