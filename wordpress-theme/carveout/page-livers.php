...
<a class="site-logo" href="<?php echo carveout_theme_page_url('index'); ?>" aria-label="CARVEOUT トップへ">
  ...
  <main>
    ...
    <section class="section featured-liver-section">
      <div class="news-tabs liver-tabs" id="liverCategoryTabs" aria-label="アプリ別所属ライバー"></div>
      <div class="featured-liver-grid" id="allLiverGrid" aria-live="polite"></div>
    </section>
  </main>
