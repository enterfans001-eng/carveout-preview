...
<head>
  ...
  <meta name="description" content="CARVEOUTのインタビュー詳細ページです。">
  <title>インタビュー詳細 | CARVEOUT</title>
...
<a class="site-logo" href="<?php echo carveout_theme_page_url('index'); ?>" aria-label="CARVEOUT トップへ">
  ...
  <main>
    ...
    <section class="section detail-section">
      <article class="detail-panel" id="interviewDetail" aria-live="polite"></article>
    </section>
  </main>
