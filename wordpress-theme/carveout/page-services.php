...
<head>
  ...
  <meta name="description" content="CARVEOUTのライバー・クリエイター向けサポート内容を紹介します。">
  <title>サービス | CARVEOUT</title>
...
<a class="site-logo" href="<?php echo carveout_theme_page_url('index'); ?>" aria-label="CARVEOUT トップへ">
  ...
  <main>
    <section class="page-header">
      ...
      <h1>サポート体制</h1>
      <p>活動を始める前、伸び悩んだ時、次の挑戦をしたい時。ライバー・クリエイターの段階に合わせて必要な支援を用意しています。</p>
    </section>

    <section class="services">
      <article class="service-item">
        <h2>活動プラン設計</h2>
        <p>プロフィール、発信ジャンル、活動時間、初回のテーマを一緒に整理します。未経験でも、始める前の不安を具体的な準備に変えます。</p>
      </article>
      <article class="service-item">
        <h2>活動改善ミーティング</h2>
        <p>視聴者やフォロワーの反応、コメントの流れ、応援につながるコミュニケーションを振り返り、次に試す改善案を決めます。</p>
      </article>
      <article class="service-item">
        <h2>イベント・案件対策</h2>
        <p>イベントや案件の選定、目標設定、期間中の告知、活動スケジュールを整理。無理なく挑戦できる計画を作ります。</p>
      </article>
      <article class="service-item">
        <h2>SNS連携・ファンづくり</h2>
        <p>X、Instagram、TikTokなどの投稿内容と日々の活動を連動させ、より多くの人に見つけてもらえる導線を整えます。</p>
      </article>
    </section>
  </main>
