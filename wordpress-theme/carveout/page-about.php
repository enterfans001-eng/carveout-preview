...
<head>
  ...
  <meta name="description" content="ライバー事務所CARVEOUTの会社概要ページです。">
  <title>会社概要 | CARVEOUT</title>
...
<a class="site-logo" href="<?php echo carveout_theme_page_url('index'); ?>" aria-label="CARVEOUT トップへ">
  ...
  <main>
    <section class="page-header">
      ...
      <h1>会社概要</h1>
      <p>ライバー事務所カーブアウトを運営する、株式会社エンターファンズの会社概要です。</p>
    </section>
    ...
    <section class="company-info">
      <table class="info-table">
        <tr>
          <th>サービス名</th>
          <td>ライバー事務所カーブアウト / CARVEOUT</td>
        </tr>
        <tr>
          <th>運営会社</th>
          <td>株式会社エンターファンズ / EnterFans Inc.</td>
        </tr>
        <tr>
          <th>代表者</th>
          <td>中川 拓哉</td>
        ...
        <tr>
          <th>所在地</th>
          <td>〒151-0051<br>東京都渋谷区千駄ヶ谷5-27-5<br>WeWorkリンクスクエア新宿 16F</td>
        </tr>
        <tr>
          <th>事業内容</th>
          <td>ライバー事務所カーブアウトの運営、Vライバー事務所リニアの運営、音楽事務所インターライン・ミュージックの運営、芸能事務所アイソセレスの運営、ライブコマース支援、TikTokアカウント運用支援、ECサイト運営支援、WEBサイト制作</td>
        </tr>
        <tr>
          <th>決算期</th>
          <td>4月</td>
        ...
        <tr>
          <th>取引銀行</th>
          <td>三井住友銀行、みずほ銀行、城南信用金庫、楽天銀行</td>
        </tr>
      </table>
    </section>
  </main>
